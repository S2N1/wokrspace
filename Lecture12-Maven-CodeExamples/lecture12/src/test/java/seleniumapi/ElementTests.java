...
public class ElementTests {
	...
	public void testElementText()
	{
		...
		Assert.assertEquals("The value of the special text for color is not equal", "Click on me and my color will change", messageText);
		...
		Assert.assertEquals("Div's Text\nSpan's Text",area.getText());
	}
